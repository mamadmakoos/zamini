...
class gallery {
    ...
    changeActiveDot(i) {
        for (let j = 0; j < this.dots.length; j++) {
            this.dots[j].classList.remove('gallery-active');
        }
        this.dots[i].classList.add('gallery-active');
    }
    ...
    setActiveDotByScroll() {
        ...
        this.slider.addEventListener('scroll', () => {
            ...
            for (let i = 0; i < this.dots.length; i++) {
                this.dots[i].classList.remove('gallery-active');
            }

            this.dots[currentIndex].classList.add('gallery-active');
...
window.addEventListener('load',function (){
    var container = document.querySelector('.gallery .innerContainer');
    new gallery(container,3);
})

...
class mainpooshsesh{
    ...
    changeActiveDot(i) {
        for (let j = 0; j < this.dots.length; j++) {
            this.dots[j].classList.remove('mainpooshsesh-active');
        }
        this.dots[i].classList.add('mainpooshsesh-active');
    }
    ...
    setActiveDotByScroll() {
        ...
        this.slider.addEventListener('scroll', () => {
            ...
            for (let i = 0; i < this.dots.length; i++) {
                this.dots[i].classList.remove('mainpooshsesh-active');
            }

            this.dots[currentIndex].classList.add('mainpooshsesh-active');
    ...
    createDots() {
        ...
        for (let i = 0; i < dotCount; i++) {
            ...
            if (i === 0) {
                dot.classList.add('mainpooshsesh-active');
            }
...
window.addEventListener('load',function (){
    var container = document.querySelector('.mainpooshsesh .innerContainer');
    new mainpooshsesh(container,3);
})
